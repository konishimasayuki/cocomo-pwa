    ...
    >
      ...
      >
        <Link href="/history" style={{ textDecoration: 'none', textAlign: 'center', color: itemColor('/history') }}>
          ...
          <div style={{ fontSize: 9, marginTop: 2 }}>履歴</div>
        </Link>

        <Link href="/gachi" style={{ textDecoration: 'none', textAlign: 'center', color: itemColor('/gachi') }}>
          <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
            <rect x="4" y="4" width="16" height="16" rx="2" />
            <path d="M8 12h8M8 16h5" />
          </svg>
          <div style={{ fontSize: 9, marginTop: 2 }}>ガチガチ</div>
        </Link>
        ...
        >
          ...
          <div style={{ fontSize: 9, marginTop: 2, color: pathname === '/' ? 'var(--accent)' : 'var(--text-muted)' }}>
            ホーム
          </div>
        </Link>
        ...
        <Link href="/gousei" style={{ textDecoration: 'none', textAlign: 'center', color: itemColor('/gousei') }}>
          ...
          <div style={{ fontSize: 9, marginTop: 2 }}>合成オッズ</div>
        </Link>
        ...
        <Link href="/settings" style={{ textDecoration: 'none', textAlign: 'center', color: itemColor('/settings') }}>
          ...
          <div style={{ fontSize: 9, marginTop: 2 }}>設定</div>
        </Link>
      </div>
    </nav>
  );
